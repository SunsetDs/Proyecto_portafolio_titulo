...
public final class FragmentCameraBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout ocrResultBar;
  ...
  private FragmentCameraBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton btnCapture, @NonNull Button btnCopyText,
      @NonNull ConstraintLayout ocrResultBar, @NonNull TextView tvOcrResult,
      @NonNull PreviewView viewFinder) {
    this.rootView = rootView;
    this.btnCapture = btnCapture;
    this.btnCopyText = btnCopyText;
    this.ocrResultBar = ocrResultBar;
  ...
  public static FragmentCameraBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.ocr_result_bar;
      ConstraintLayout ocrResultBar = ViewBindings.findChildViewById(rootView, id);
      if (ocrResultBar == null) {
        break missingId;
      }

      id = R.id.tv_ocr_result;
      ...
      return new FragmentCameraBinding((ConstraintLayout) rootView, btnCapture, btnCopyText,
          ocrResultBar, tvOcrResult, viewFinder);
    }
